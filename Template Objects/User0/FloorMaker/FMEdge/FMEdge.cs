...
namespace ShapeTemplateLib.Templates.User0
{
    ...
    /// </summary>
    public partial class FMEdge : Edge
    {
        /*
         ...
         */
        public int InteriorDoorCandidate { get; set; }
        public int DoorPresent { get; set; }
        public int ExteriorWindowCandidate { get; set; }
        ...
        public bool SameEndPoints(FMEdge r)
        {
            return Equals(r) || (p1 == r.p2 && p2 == r.p1);
        }

        public bool Equals(FMEdge input)
        {
