...
namespace ShapeTemplateLib.Templates.User0
{
    ...
    public partial class FloorMaker : TemplateBaseClass
    {
        ...
        /// <returns></returns>
        public void SplitEdge(FMEdge oEdge,int Width, int Numerator,int Denominator)
        {
            ...
            FMEdge oNewEdge = new FMEdge()
            {
                ...
                InteriorDoorCandidate = oEdge.InteriorDoorCandidate,
                ExteriorWindowCandidate = oEdge.ExteriorWindowCandidate,
                ID=oEdge.ID,
                Height=oEdge.Height
