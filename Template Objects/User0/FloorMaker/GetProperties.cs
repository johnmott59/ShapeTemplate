    ...
    public partial class FloorMaker
    {
        public override XElement GetProperties(string PropertyName = "")
        {
          ...
          new XAttribute("name", "FloorLayout".ToLower()));
            ...
            XElement XRoomList = new XElement("list", new XAttribute("name", nameof(AssembledRoomList).ToLower()));
            root.Add(XRoomList);
        ...
        protected XElement GetRoomList()
        {
            ...
            foreach (FMAssembledRoom r in AssembledRoomList)
            {
