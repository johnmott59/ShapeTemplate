...
namespace ShapeTemplateLib.Templates.User0
{
     ...
     */
    public partial class FMDestinationRoom : ILoadAndSaveProperties
    {
        ...
        // These are the rooms that this open area touches
        public List<FMAssembledRoom> RoomList { get; set; } = new List<FMAssembledRoom>();
    }
