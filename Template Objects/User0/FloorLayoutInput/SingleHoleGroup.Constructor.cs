...
namespace ShapeTemplateLib.Templates.User0
{
    ...
    {
        public SingleHoleGroup()
        {
            oHoleGroup = new HoleGroup();

            RectangleArray = new BoundaryRectangle[0];
            EllipseArray = new BoundaryEllipse[0];
            PolygonArray = new BoundaryPolygon[0];
    }
    }
}
